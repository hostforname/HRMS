			...
			<div class="admin-biaogelist" style="margin-top: 0px;margin-left: 0px;">
				<div class="listbiaoti am-cf">
					...
					<dl class="am-icon-home" style="float: right;">
						当前位置： 首页 > <a href="#">添加培训信息</a>
					</dl>
					<!--data-am-modal="{target: '#my-popup'}" 弹出层 ID  弹出层 190行 开始  271行结束-->

				</div>
				<div class="fbneirong">
					<form class="am-form" action="AddTraSer" method="post">
						<div class="am-form-group am-cf">
							<div class="zuo">培训人：</div>
							<div class="you">
								<input type="text" name="txtTraEr" class="am-input-sm" id="doc-ipt-email-1">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">培训主题：</div>
							<div class="you">
								<input type="text" name="txtTraTl" class="am-input-sm" id="doc-ipt-email-1">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">培训时间：</div>
							<div class="you">
								<input type="text" name="txtTraTm" class="am-input-sm" id="doc-ipt-email-1" placeholder="yyyy-MM-DD">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">培训地点：</div>
							<div class="you">
								<input type="text" name="txtTraAd" class="am-input-sm" id="doc-ipt-email-1">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">详细信息：</div>
							<div class="you">
								<textarea class="" name="txtTraDi" rows="2" id="doc-ta-1"></textarea>
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo"></div>
